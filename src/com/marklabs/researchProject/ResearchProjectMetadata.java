...
public class ResearchProjectMetadata {
	 ...
	 */
	public int getRequestedBaseCost() {
		return requestedBaseCost;
	}
	/**
	 * @param requestedBaseCost the requestedBaseCost to set
	 */
	public void setRequestedBaseCost(int requestedBaseCost) {
