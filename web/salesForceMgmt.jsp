...
<% 
	...
	int totalAvailableSalesForce = (Integer)request.getAttribute(Constants.TOTAL_AVAILABLE_SALES_FORCE_TO_ALLOCATE);
...
<fieldset>
					...
					<div class="columns">
	        			<div class="colx1">
							<span class="label"></span>
							<strong>Total available Sales Force left to be allocated for Period <%= currentPeriod%>: <%= totalAvailableSalesForce%></strong>
						</div>
					</div>
				...
				<div class="columns">
						...
						<div class="colx5-right">
							<span class="label"></span>
							<input type="button" class="button generate" value="Evaluate">
						</div>
					</div>	  
